...
import ChangePriceModal from "@/components/admin/modals/ChangePriceModal";
...
export default function AdminProductosPage() {
    ...
    const createProductHandler = async () => {
        ...
        try {
            ...
            setCategories(prev =>
                prev.map(cat =>
                    cat.id === created.category_id
                        ? {
                            ...cat,
                            products: [...cat.products, fullProduct],
                        }
                        : cat
                )
            );
    ...
    return (
        ...
        {businessId && (
            ...
            <EditProductModal
                ...
                setProduct={(p) => setSelectedProduct(p)}
                    ...
                    onSave={async (newPrice) => {
                        ...
                        setCategories(prev =>
                            prev.map(cat => ({
                                ...cat,
                                products: cat.products.map(p =>
                                    p.id === priceProduct.id ? { ...p, price: newPrice } : p
                                ),
                            }))
                        );
